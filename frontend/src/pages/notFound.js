...
export function NotFound(){
    ...
    <div className="mt-44 mb-44 p-12">
        ...
        <div class="p-12 flex flex-col space-y-4 sm:flex-row sm:justify-center sm:space-y-0">
                        <a href="/" class="inline-flex justify-center text-lg items-center py-3 px-5 text-base font-Lexend border border-white text-center text-white rounded-lg bg-blackShade hover:bg-white hover:text-blackShade">
                            Return home
                        </a>
