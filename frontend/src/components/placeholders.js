...
function StatusBannerPlaceholder(){
    return(
        <>
            <div role="status" class="animate-pulse">
                <div class="h-2.5 bg-gray-300 rounded-full  max-w-[640px] mb-2.5 mx-auto"></div>
                <div class="h-2.5 mx-auto bg-gray-300 rounded-full  max-w-[540px]"></div>
...
<div role="status" class="max-w-md p-4 space-y-4 divide-y divide-gray-200 rounded shadow animate-pulse md:p-6">
...
function ImagePlaceholder(){
    return (
        ...
        <div role="status" class="flex items-center justify-center h-full w-full bg-gray-300 rounded-lg animate-pulse">
            <svg class="w-full h-96 text-gray-200 p-8" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 16 20">
                <path d="M5 5V.13a2.96 2.96 0 0 0-1.293.749L.879 3.707A2.98 2.98 0 0 0 .13 5H5Z"/>
...
export {TextPlaceholder, StatusBannerPlaceholder, CardPlaceholder, ListPlaceholder, ImagePlaceholder, DefaultSkeleton}